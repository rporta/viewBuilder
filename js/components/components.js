...
var preloaderCircle = new configComponent({
	...
	template: '<transition name="fade"><div key="this.generateId(5)" v-show="this.show" v-bind:class="this.size"  class="preloader-wrapper active">\
...
var blockquotes = new configComponent({
	...
	methods: {
		...
		setStyle: function() {
			...
			if (this.colorHexa) {
				out = {
					borderLeftColor: this.colorHexa
				};
			}
			return out;
		}
